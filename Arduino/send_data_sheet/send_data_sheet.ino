...
String GOOGLE_SCRIPT_ID = "AKfycbzm2Q_81_XIOcQyOCKJzlbb3Z8lDELFR8tGbGER9uQyXp4gOxTLBsdZCQAhfyeT80SS";    // change Gscript ID
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            if (header.indexOf("GET /26/on") >= 0) {
              ...
              String urlFinal = "https://script.google.com/macros/s/"+GOOGLE_SCRIPT_ID+"/exec?"+"temperature=" + String(temp) + "&humidity=" + String(humidity)+ "&light=" + String(light);
